                           ...
                           .map(p => {
                             ...
                             return (
                               <div 
                                 ...
                                 style={{ padding: '0.6rem 0.8rem', borderRadius: '6px', cursor: 'pointer', display: 'flex', justifyContent: 'space-between', alignItems: 'center', backgroundColor: isSelected ? '#eff6ff' : 'transparent', fontWeight: isSelected ? 700 : 500, color: isSelected ? '#1e40af' : '#334155' }}
                               >
