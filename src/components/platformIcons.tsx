...
export const YoutubeIcon = ({ className = 'w-4 h-4', style }: { className?: string; style?: React.CSSProperties }) => (
  <svg className={className} style={style} viewBox="0 0 24 24">
    ...
    <path d="M10 8.3v7.4l6.4-3.7z" fill="var(--m-platform-glyph, #ffffff)" />
  </svg>
);
...
export const InstagramIcon = ({ className = 'w-4 h-4', style }: { className?: string; style?: React.CSSProperties }) => (
  <svg className={className} style={style} viewBox="0 0 24 24">
    ...
    <rect x="6.3" y="6.3" width="11.4" height="11.4" rx="3.6" fill="none" stroke="var(--m-platform-glyph, #ffffff)" strokeWidth="1.8" />
    <circle cx="12" cy="12" r="3.1" fill="none" stroke="var(--m-platform-glyph, #ffffff)" strokeWidth="1.8" />
    <circle cx="16.4" cy="7.6" r="1.05" fill="var(--m-platform-glyph, #ffffff)" />
  </svg>
);
